    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-primary-foreground">YourBrand</h3>
            <p className="text-gray-400 mb-4">
              Transforming ideas into digital excellence with innovative solutions tailored to your business needs.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-300">Services</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <a href="mailto:sankalpgour2@gmail.com" className="text-gray-400 hover:text-white transition-colors">
              ...
              <li className="flex items-start">
                ...
                <a href="tel:+919977827050" className="text-gray-400 hover:text-white transition-colors">
                  +91 9977827050
                </a>
              </li>
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  123 Business Avenue, Tech Park, City
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center">
            <button
              onClick={scrollToTop}
              className="ml-4 bg-primary/20 hover:bg-primary/30 text-primary-foreground p-2 rounded-full transition-colors"
